...
public class Main
{
     ...
     * @throws RhinoException thrown during evaluation of sourceit with the current thread. Then set up the execution environment and begin to execute scripts.rrent thread. Then set up the execution environment and begin to execute scripts.
     */
