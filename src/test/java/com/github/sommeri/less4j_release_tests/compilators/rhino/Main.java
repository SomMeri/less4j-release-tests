...
package com.github.sommeri.less4j_release_tests.compilators.rhino;
...
public class Main {
   ...
   */
  public static int main(Global _global, String args[]) {
    global = _global;
   ...
   *           thrown during evaluation of sourceit with the current thread.
   *           Then set up the execution environment and begin to execute
   *           scripts.rrent thread. Then set up the execution environment and
   *           begin to execute scripts.
   */
